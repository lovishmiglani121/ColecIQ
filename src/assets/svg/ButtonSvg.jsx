const ButtonSvg = (white) => (
  <>
    ...
    >
      <path
        fill={white ? "black" : "none"}  // Change fill to black instead of white
        stroke={white ? "white" : "url(#btn-left)"} // Change stroke to black
        strokeWidth="2"
    ...
    <svg
      ...
      fill={white ? "black" : "none"}  // Change fill to black
    >
      {white ? (
        <polygon
          fill="black"  // Change fill to black
          fillRule="nonzero"
          stroke={white ? "white" : "none"}
    ...
    >
      <path
        fill={white ? "black" : "none"}  // Change fill to black
        stroke={white ? "white" : "url(#btn-right)"}  // Change stroke to black
        strokeWidth="2"
